...
@section('content')
    ...
    <div class="cart-box-main">
    	...
    	@endif
        <div class="container">
            <center><h1 style="font-size: 55px">Cart</h1></center>
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="thumbnail-img">
                                        <a href="#">
									<img class="img-fluid" src="{{url('/upload/product/'.$cart->image)}}" alt="" />
								</a>
                                    </td>
                                    <td class="name-pr">
                                    ...
                                    <td class="quantity-box">
                                    	...
                                    	<input type="text" size="4" value="{{$cart->product_quantity}}" min="0" step="1" class="c-input-text qty text" style="width: 70%">
                                    	@if($cart->product_quantity>1)
                                    	<a href="{{ url('/cart/update-quantity/'.$cart->id.'/-1') }}" style="font-size: 25px;">-</a>
                                    	@endif
                                    </td>
                                    <td class="total-pr">
                                        <p>Rs : {{$cart->product_price*$cart->product_quantity}}</p>
                                    </td>
                                    <td class="remove-pr">
            ...
            <div class="row my-5">
                ...
                <div class="col-lg-6 col-sm-6">
                    ...
                    <div class="col-12 d-flex shopping-box">
                        <a href="{{url('/checkout-page')}}" class="ml-auto btn hvr-hover">Checkout</a>
                    </div>
                </div>
            </div>
        </div>
